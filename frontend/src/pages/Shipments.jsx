...
import {
  ...
  Loader, BarChart3, RefreshCw, Tag, History, X
} from "lucide-react";
...
const Shipments = () => {
  ...
  // NEW: Selected shipment for timeline view
            ...
            <div className="bg-gray-900 rounded-xl shadow-md overflow-hidden">
              ...
              <div className="p-6">
                <form onSubmit={handleAddShipment} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className={`w-full flex justify-center items-center py-2 px-4 bg-gradient-to-r from-teal-600 to-teal-500 text-white rounded-lg shadow hover:shadow-lg ${submitting ? "opacity-75 cursor-not-allowed" : "hover:from-teal-700 hover:to-teal-600"
            ...
            <div className="bg-gray-900 rounded-xl shadow-md overflow-hidden">
              ...
              <div className="p-6">
                <form onSubmit={handleUpdateShipmentStatus} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className={`w-full flex justify-center items-center py-2 px-4 bg-gradient-to-r from-amber-600 to-amber-500 text-white rounded-lg shadow hover:shadow-lg ${updating ? "opacity-75 cursor-not-allowed" : "hover:from-amber-700 hover:to-amber-600"
                    ...
                    <li key={shipment.trackingId} className="p-6 hover:bg-gray-50 transition-all">
                      ...
                      <div className="mt-4 pt-4 border-t border-gray-100">
                        <button
                          ...
                          className="w-full flex items-center justify-center py-2 px-4 bg-purple-100 text-purple-700 rounded-lg hover:bg-purple-200 transition-all font-medium text-sm"
                        >
                          <History className="h-4 w-4 mr-2" />
                          View Timeline & Add Notes
                        </button>
                      </div>
                    </li>
                  ))}
